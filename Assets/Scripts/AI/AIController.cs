...
public class AIController : MonoBehaviour
{
    ...
    public float startWaitTime = 0;                 //  Wait time of every action
    public float timeToRotate = 0;                  //  Wait time when the enemy detect near the player without seeing
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            enemyAudio.Stop();
            enemyAudio.clip = enemyJumpscare;
